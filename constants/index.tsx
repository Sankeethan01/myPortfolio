...
export const FRONTENDSKILLS = [
  ...
  {
    id:4,
    icon: <Image src={tailwindcssImg} alt="tailwindcss" width={60} height={60} />,
    name: "Tailwind CSS",
  },
  {
    id:5,
    icon: <Image src={reactnativeImg} alt="reactnative" width={60} height={60} />,
    name: "React Native",
  },
  {
    id:6,
...
export const EDUCATION = [
  {
    ...
    description:
      "Fundamendals to Advance computer science field education.",
      img:<Image src={uwuImg} alt="uwu" width={150} height={150} className="rounded-md object-cover"/>,
  },
  {
    ...
    description:
      ...
      img:<Image src={jhcImg} alt="jhc" width={150} height={150} className="rounded-md object-cover"/>,
  },
